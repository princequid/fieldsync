...
export default function Forbidden() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#f5f2ee] px-4 py-12">
      <div className="w-full max-w-md rounded-3xl bg-white p-10 text-center shadow-[0_20px_60px_rgba(30,58,95,0.12)]">
