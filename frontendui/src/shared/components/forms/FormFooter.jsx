...
export default function FormFooter({
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 h-[68px] bg-white border-t border-[#F1F5F9] flex items-center justify-between px-6 ${className}`}
      style={{
    ...
    >
      <button
        ...
        className="px-6 py-2 text-[13px] font-medium text-[#374151] bg-white border border-[#E2E8F0] rounded-[8px] hover:bg-[#F8FAFC] transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {cancelText}
      </button>
