...
export default function FormTextarea({
  ...
  const baseClasses =
    "w-full min-h-[100px] px-3 py-2 text-[13px] text-[#0F172A] bg-[#F8FAFC] border border-[#E2E8F0] rounded-[8px] outline-none transition-all duration-150 resize-y font-sans";
    ...
    <div className="block">
      ...
      <div className="flex items-start justify-between gap-2 mt-1.5">
        <div>
          ...
          {!error && helperText && (
            <p className="text-[11px] text-[#94A3B8]">{helperText}</p>
          )}
        </div>
