      ...
      <div className="flex-1 pb-24">
        ...
        <div className="space-y-4 p-4">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="fs-card flex min-h-11 items-center gap-3 p-4"
          >
  ...
  return (
    <div className="sticky bottom-0 z-10 border-t border-[#E5E7EB] bg-white/95 px-4 py-4 backdrop-blur-sm">
      <button
        type="button"
        disabled
        className="w-full cursor-not-allowed rounded-2xl bg-[#1E3A5F] text-sm font-semibold text-white opacity-90"
        style={{ minHeight: "56px" }}
      >
        This job is closed
      </button>
