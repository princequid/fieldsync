...
export default function CompleteJob() {
  ...
  const inProgressEntry = job.statusHistory?.find((entry) => entry.status === "IN_PROGRESS");
    ...
    return (
      <div className="flex min-h-full flex-col items-center justify-center px-4 py-12 text-center">
        ...
        <p className="mt-2 max-w-xs text-sm text-gray-500 leading-relaxed">
          <span className="font-semibold text-gray-700">{job.title}</span> has been marked as completed and is awaiting admin verification.
        </p>
