    ...
    <div className="space-y-4 p-4">
      ...
      <section className="fs-card flex items-center gap-4 p-5">
        ...
        <div>
          ...
          <p className="text-[12px] text-gray-400">Field Technician</p>
        </div>
      </section>
      ...
      {/* Contact info */}
      <section className="fs-card divide-y divide-black/5">
        {profile?.email && (
      ...
      <button
        ...
        className="fs-btn-press fs-focus-ring flex h-11 w-full items-center justify-center gap-2 rounded-button border border-red-200 bg-white text-[13px] font-medium text-red-600"
      >
      ...
      {showSignOut && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/35 p-4 backdrop-blur-sm sm:items-center">
          <div className="animate-sheet-up w-full max-w-sm rounded-modal border border-black/6 bg-white p-5 shadow-4">
            ...
            <div className="mt-5 flex gap-2.5">
              <button
                ...
                className="fs-btn-press fs-focus-ring flex-1 rounded-button border border-black/8 bg-white py-2.5 text-[13px] font-medium text-gray-700"
              >
                Cancel
              </button>
              <button
...
function ProfileStatTile({ label, value, accent }) {
  return (
    <div
      className="rounded-card border border-black/6 bg-white p-3 text-center"
