...
export default function TechProfile() {
  ...
  // availability toggle G현 reads from userData, technician can flip it locally
      ...
      <div className="mx-4 mt-6 rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
        ...
        <div className="px-5 pb-5 -mt-8">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            {/* availability toggle G현 technician can tap this */}
            <button
              type="button"
      ...
      <div className="space-y-3 px-4 mt-3">
        ...
        <section className="rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
          ...
          <InfoRow
            ...
            iconBg="bg-blue-50"
            label="Email"
            value={userData?.email ?? user?.email ?? "G현"}
          />
          <InfoRow
            icon={<Phone size={14} className="text-[#27AE60]" />}
            iconBg="bg-green-50"
            label="Phone"
            value={userData?.phone || "G현"}
          />
          <InfoRow
        ...
        {/* specialisations G현 read only, set by admin */}
        <section className="rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
